...
%global srcname sphinxcontrib-paradoxy
%global summary Adds links to Doxygen objects within Sphinx
%global common_desc \
This package contains a Sphinx extension that makes it\
very easy to add links to objects of a project documented\
with Doxygen <http://www.doxygen.org>.
...
%{python2_sitelib}/sphinxcontrib_paradoxy*

%if 0%{?with_python3}
%files -n python3-%{srcname}
%license python3-%{srcname}-%{version}/LICENSE
%{python3_sitelib}/sphinxcontrib/
%{python3_sitelib}/sphinxcontrib_paradoxy*
%endif
